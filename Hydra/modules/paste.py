...
from Hydra import aiohttpsession, pgram
from Hydra.utils.errors import capture_err
from Hydra.utils.pastebin import paste
...
async def paste_func(_, message):
    ...
    button.add(InlineKeyboardButton(text="View", url=link))
