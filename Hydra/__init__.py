...
# Credits Logger
print("[Hydra] Hydra Is Starting. | Team • Wolf Project | BSD 2-Clause License.")
print("[Hydra] Successfully Connected With Team wolf • Data Base • Karur")
print(
    "[Hydra] Project Maintained By: github.com/Otazuki004 (https://github.com/Hydradevlopment3.0)"
)
...
print("[Hydra]: Connecting To Team wolf • Data Base • Chennai • PostgreSQL Database")
ubot = TelegramClient(StringSession(STRING_SESSION), API_ID, API_HASH)
print(
    "[Hydra]: Connecting To Database • Hydra Userbot (https://telegram.dog/Awesome_Neko)"
)
